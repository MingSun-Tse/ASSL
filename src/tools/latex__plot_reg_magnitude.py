...
'''Usage Example:
    python tools/latex__plot_reg_magnitude.py ../experiment/EDSR_F64R16BIX2_DF2K_Prune0.9_RGP0.0001_RUL0.5_Pretrain/log_prune.txt model.body.4.body.2 
'''
...
ax1.set_ylabel('Mean $L_1$-norm', fontsize=fs)
ax2.set_ylabel('Regularization co-efficient', fontsize=fs)
...
ax1.plot(step, mag_pruned, color = 'blue', linestyle='dotted', label='Pruned filters')
ax1.plot(step, mag_kept, color = 'blue', linestyle='solid', label='Kept filters')
